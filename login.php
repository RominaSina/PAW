                	...
                	<div class="loginbox">
                        <div class="login-right">
							<div class="login-right-wrap">
								<h1>Login</h1>
								<p class="account-subtitle">Aksesoni llogarin tuaj</p>
								...
								<form method="post">
									...
									<div class="form-group">
										...
										<button class="btn btn-success" name="login" value="Login" type="submit">Hyni</button>
									
								</form>
								
								<div class="login-or">
									<span class="or-line"></span>
									<span class="span-or">ose</span>
								</div>
								<!-- FOR MORE PROJECTS visit: codeastro.com -->
								<!-- Social Login -->
								...
								<div class="text-center dont-have">Nuk keni nje adrese? <a href="register.php">Rrgjistrohuni</a></div>
