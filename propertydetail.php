    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Detajet e prones</b></h2>
                    </div>
                    <div class="col-md-6">
                        <nav aria-label="breadcrumb" class="float-left float-md-right">
                            <ol class="breadcrumb bg-transparent m-0 p-0">
                                <li class="breadcrumb-item text-white"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Detajet e prones</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="property-details">
                            <div class="bg-gray property-quantity px-4 pt-4 w-100">
                                <ul>
                                    <li><span class="text-secondary"><?php echo $row['12'];?></span> Siperfaqe</li>
                                    <li><span class="text-secondary"><?php echo $row['6'];?></span> Dhoma gjumi</li>
                                    <li><span class="text-secondary"><?php echo $row['7'];?></span> Banjo</li>
                                    <li><span class="text-secondary"><?php echo $row['8'];?></span> Ballkon</li>
                                    <li><span class="text-secondary"><?php echo $row['10'];?></span> Sall</li>
                                    <li><span class="text-secondary"><?php echo $row['9'];?></span> Kuzhin</li>
                                </ul>
                            </div>
                            <h4 class="text-secondary my-4">Pershkrimi</h4>
                            <p><?php echo $row['2'];?></p>
                            
                            <h5 class="mt-5 mb-4 text-secondary">Permbledhja e pasurise</h5>
                            ...
                            <h5 class="mt-5 mb-4 text-secondary">Vecorit</h5>
                            <div class="row">
								<?php echo $row['17'];?>
								
                            </div>   
							<!-- FOR MORE PROJECTS visit: codeastro.com -->
                            <h5 class="mt-5 mb-4 text-secondary">Planimetria</h5>
                            ...
                            <h5 class="mt-5 mb-4 text-secondary double-down-line-left position-relative">Kontaktoni agjentin</h5>
                    ...
                    <div class="col-lg-4">
                        ...
                        <h4 class="double-down-line-left text-secondary position-relative pb-4 my-4">Llogaritesi i kesteve</h4>
                        <form class="d-inline-block w-100" action="calc.php" method="post">
                            <label class="sr-only">Cmimi i prones</label>
                            ...
                            <label class="sr-only">Norma e interesit</label>
                            <div class="input-group mb-2 mr-sm-2">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">%</div>
                                </div>
                            ...
                            <button type="submit" value="submit" name="calc" class="btn btn-danger mt-4">Llogaritesi i kesteve</button>
                        </form>
                        <h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4 mt-5">Prona ne gjendje</h4>
                        ...
                        <div class="sidebar-widget mt-5">
                            <h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4">Prona te shtuara se fundmi</h4>
                            <ul class="property_list_widget">
