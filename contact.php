                ...
                <div class="row">
                    <div class="col-lg-4 mb-5 bg-secondary">
                        <div class="contact-info">
                            <h3 class="mb-4 mt-4 text-white">Kontaktet</h3>
							
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Adresa</h5>
                                        <span class="text-white">27 rruga e Elbasanit, Tirane</span> <br>
										<span class="text-white">27 Don Bosko, Tirane</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Na telefononi</h5>
                                        <span class="d-table text-white">+068-357-8910</span>
										<span class="text-white">+069-765-4321 </span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Adresa e emailit</h5>
                    ...
                    <div class="col-md-12 col-lg-7">
                        ...
                        <div class="row">
							<div class="col-lg-12">
								<h2 class="text-secondary double-down-line text-center mb-5">Krijoni kontakt</h2>
							...
							<div class="col-md-12">
								<form class="w-100" action="#" method="post">
									<div class="row">
										...
										<button type="submit" value="send message" name="send" class="btn btn-success">Dergoni nje mesazh</button>
									</div>
								</form>
							</div>
						</div>
