                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="sidebar-widget">
                            <h4 class="double-down-line-left text-secondary position-relative pb-4 my-4">Llogaritesi me keste</h4>
						<form class="d-inline-block w-100" action="calc.php" method="post">
                            ...
                            <label class="sr-only">Muaj</label>
                            <div class="input-group mb-2 mr-sm-2">
                                <div class="input-group-prepend">
                            ...
                            <button type="submit" value="submit" name="calc" class="btn btn-danger mt-4">Llogaritesi me keste</button>
                        </form>
                        </div>
